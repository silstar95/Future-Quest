  ...
  return (
    <div className="max-w-4xl mx-auto relative">
      ...
      <div className="relative z-10">
        {/* Task Description */}
        {showDescription && (
          <Card className="mb-6 border-brand-primary/20 bg-brand-primary/5 backdrop-blur-sm bg-white/90">
            <CardHeader>
        ...
        <Card className="border-2 border-blue-200 shadow-lg backdrop-blur-sm bg-white/95">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl">Task 1: Financial Health Check-Up</CardTitle>
