  ...
  const handleGoogleSignUp = async () => {
    ...
    if (!formData.school.trim()) {
      toast({
        ...
        description: "Please enter your school name before continuing with Google signup.",
        variant: "destructive",
      })
      return
    }
    ...
    if (activeTab === "student" && !formData.grade) {
      toast({
        title: "Missing information",
        description: "Please select your grade level before continuing with Google signup.",
        variant: "destructive",
      })
      return
    }
    ...
    if (activeTab === "educator") {
      if (!formData.role.trim()) {
        toast({
          title: "Missing information",
          description: "Please enter your role before continuing with Google signup.",
          variant: "destructive",
        })
        return
      }
      if (!formData.studentCount) {
        toast({
          title: "Missing information",
          description: "Please select how many students you're responsible for.",
          variant: "destructive",
        })
        return
      }
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value={activeTab} className="space-y-6">
              ...
              <div className="space-y-3">
                {(activeTab === "student" && (!formData.school || !formData.grade)) ||
                (activeTab === "educator" && (!formData.school || !formData.role || !formData.studentCount)) ? (
                  <div className="text-sm text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-200">
                    Please fill in the required fields below before using Google signup.
                  </div>
                ) : null}
